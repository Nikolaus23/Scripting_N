...
document.getElementById('column1').innerHTML="<h3>Holy cow!</h3>";
document.getElementById('column1').innerHTML+="<p>This a odd way to edit a HTML page but I guess it works?</p>";
document.getElementById('column1').innerHTML+="<p>I like music not improtant but true.</p>";
...
if(weapon=="Squid"){
    console.log("Squid time");
}else if(weapon=="Dogs"){
    
    console.log("The dogs are loses.");
}else{
    console.log("Illigal weapon calling cops");
}
...
/// ifthe weapon is squid then the damage points is 50
// but if the weapon is dog the the damage is 25
// other wise it is zero
if(weapon=="Squid"){
    damage=50;
}else if(weapon=="Dogs"){
    damage=25;
...
// healt to equal current health minus damage
