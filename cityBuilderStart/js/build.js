...
document.getElementById('city').innerHTML = "<p>you have " + buildings + " buildings in your city</p>";
//Functions -- 
...
//Let go more one more building
function buildFour(){
    console.log("In the function");

buildings++;
document.getElementById('city').innerHTML = "<p>you have " + buildings + " buildings in your city</p>";
document.getElementById('cityGraphic').innerHTML += "<img src='images/SateliteDish2.png'>";
}
